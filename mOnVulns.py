...
import pyfiglet
import platform #Verificar sé é um widnows ou linux
...
if args.nf:
    while True:
        ...
        print(f"{Fore.BLUE} \t\t    Made by: Carlos             Version: 1.5{Style.RESET_ALL}\n", end='')
        ...
        if args.s == "exploit-db":
            ...
            merge_pdfs(pdf_files_fi,f'{args.w}.pdf') #juntar tudo
